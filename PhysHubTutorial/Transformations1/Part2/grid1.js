...
//Lets get the slider
const zoomSlider = document.getElementById("zoomSlider1");
const label = document.getElementById("zoomSliderLabel1");
const transLabel = document.getElementById("transSliderLabel1");
const transSlider = document.getElementById("transSlider1");
